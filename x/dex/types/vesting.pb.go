...
// source: vesting/dex/vesting.proto
...
func (*Vesting) Descriptor() ([]byte, []int) {
	return fileDescriptor_025de47bf1a9d158, []int{0}
}
...
func (m *Vesting) GetStart() string {
	if m != nil {
		return m.Start
	}
	return ""
...
func (m *Vesting) GetDuration() string {
	if m != nil {
		return m.Duration
	}
	return ""
...
func (m *Vesting) GetParts() string {
	if m != nil {
		return m.Parts
	}
	return ""
...
func (m *Vesting) GetCreator() string {
	if m != nil {
		return m.Creator
	}
	return ""
...
func init() {
	proto.RegisterType((*Vesting)(nil), "vesting.dex.Vesting")
}

func init() { proto.RegisterFile("vesting/dex/vesting.proto", fileDescriptor_025de47bf1a9d158) }

var fileDescriptor_025de47bf1a9d158 = []byte{
	// 185 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *Vesting) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Creator) > 0 {
		...
		i = encodeVarintVesting(dAtA, i, uint64(len(m.Creator)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Parts) > 0 {
		i -= len(m.Parts)
		copy(dAtA[i:], m.Parts)
		i = encodeVarintVesting(dAtA, i, uint64(len(m.Parts)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Duration) > 0 {
		...
		i = encodeVarintVesting(dAtA, i, uint64(len(m.Duration)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Start) > 0 {
		i -= len(m.Start)
		copy(dAtA[i:], m.Start)
		i = encodeVarintVesting(dAtA, i, uint64(len(m.Start)))
		i--
		dAtA[i] = 0x12
	}
	if m.Id != 0 {
		i = encodeVarintVesting(dAtA, i, uint64(m.Id))
		i--
		dAtA[i] = 0x8
	}
